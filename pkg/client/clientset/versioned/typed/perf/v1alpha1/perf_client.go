...
import (
	...
	"github.com/n3wscott/knperf/pkg/client/clientset/versioned/scheme"
...
// PerfV1alpha1Client is used to interact with features provided by the perf.knative.dev group.
type PerfV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PerfV1alpha1Client) PerfJobs(namespace string) PerfJobInterface {
	return newPerfJobs(c, namespace)
}
...
// New creates a new PerfV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *PerfV1alpha1Client {
	return &PerfV1alpha1Client{c}
}
